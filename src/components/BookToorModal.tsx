...
const BookToorModal: React.FC<BookToorModalProps> = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4 max-h-[90vh]">
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-4xl p-6 sm:p-10 h-full overflow-scroll my-auto">
        <button
